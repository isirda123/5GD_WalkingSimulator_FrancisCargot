...
namespace StylizedWaterShader
{
    ...
    public class StylizedWaterInspector : Editor
    {
        ...
        void DoInfo()
        {
            ...
            {
                if (stylizedWater.currentCam.name != "SceneCamera" && stylizedWater.currentCam.depthTextureMode == DepthTextureMode.None && stylizedWater.currentCam.actualRenderingPath != RenderingPath.DeferredLighting)
                {
            ...
            if (EditorGUILayout.BeginFadeGroup(lightingSection.anim.faded))
            {
                ...
                switch (lightingMethod.intValue)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        EditorGUILayout.HelpBox("Material uses all Unity lighting and up to 3 points light (spot lights excluded)", MessageType.None);
                        break;
                }
